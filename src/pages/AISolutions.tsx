...
// Violet animated glow for AI hero
function AiHeroBackground() {
  return (
    <div className="absolute inset-0 pointer-events-none z-[1] overflow-hidden">
      {/* Primary glow */}
      <div
        className="absolute top-[-20%] right-[-10%] w-[70%] h-[80%] rounded-full opacity-20"
        style={{
      ...
      {/* Secondary glow */}
      <div
        className="absolute bottom-[-10%] left-[10%] w-[50%] h-[60%] rounded-full opacity-15"
        style={{
...
export function AISolutionsPage() {
  ...
  return <DivisionPage division={division} heroBackground={<AiHeroBackground />} />;
}
